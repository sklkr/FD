...
Commontator.configure do |config|
  ...
  config.user_name_proc = lambda { |customer| customer.user.full_name }
  ...
  config.user_email_proc = lambda { |customer, mailer| customer.try(:email) || '' }
  ...
  # Not yet implemented:
  #   :n (link to the form; opsens in a new window)
  # Default: :l
