...
class MypackageController < ApplicationController
  ...
  def success
    ...
    unless @passport.save
      render :text => "Payment not processed successfully. Please let us help you if you have any queries at support@fitnesspapa.com" and return
    end
    ...
    redirect_to invoice_path(format: :pdf)
  end
